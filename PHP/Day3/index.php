...
<body>
    ...
    <pre>
        ...
        nhưng có thể tính toán như cộng trừ được
    ...
    ?>
    <pre>
        vấn đề 1: chuyển định dạng thời gian timestamp về kiểu định dạng thời gian đọc được
